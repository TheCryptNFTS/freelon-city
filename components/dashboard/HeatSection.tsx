/**
 * HeatSection — trait heat (hottest traits by recent sales).
 * Folded from app/heat into the /dashboard hub. Server component;
 * fetches recent OpenSea sales and buckets them by civ/tier/caste/shape.
 */
...
export async function HeatSection() {
  ...
  return (
    <section id="heat" className="heat-page" style={{ scrollMarginTop: 96 }}>
      ...
      {total === 0 ? (
        <section className="empty-hero">
          ...
          <h3 className="empty-hero-title">The floor is quiet</h3>
