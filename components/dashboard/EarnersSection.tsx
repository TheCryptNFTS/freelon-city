/**
 * EarnersSection — top hex earners (7-day actives, balances, lifetime).
 * Folded from app/leaderboard into the /dashboard hub. Server component;
 * reuses listWalletHexRecords() and the MyRank widget.
 */
...
export async function EarnersSection() {
  ...
  return (
    <section id="earners" className="leaderboard-page" style={{ scrollMarginTop: 96 }}>
      <section className="page-hero">
        <span className="kicker">⬡ THE LEADERBOARD</span>
        <h2>Who the city <em>recognizes</em></h2>
        <p className="lead">
      ...
      <div className="lb-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "var(--s-4)" }}>
        <section>
          <h3 className="kicker" style={{ color: "var(--gold)" }}>⬡ ACTIVE · 7 DAYS</h3>
        ...
        <section>
          <h3 className="kicker">⬡ CURRENT BALANCE</h3>
          <p style={{ fontFamily: "var(--mono2)", fontSize: 10, color: "var(--ink-dim)", letterSpacing: "0.18em", marginTop: 4, marginBottom: 12 }}>
            UNBURNT ⬡ ON HAND
          </p>
        ...
        <section>
          <h3 className="kicker">⬡ LIFETIME EARNED</h3>
          <p style={{ fontFamily: "var(--mono2)", fontSize: 10, color: "var(--ink-dim)", letterSpacing: "0.18em", marginTop: 4, marginBottom: 12 }}>
