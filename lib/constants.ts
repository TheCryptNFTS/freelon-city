...
export const CIVILIZATIONS = {
  ...
  "void-404":           { name: "Void 404",         stamp: "VOI.180", doctrine: "Void/404",     role: "signal ghosts · lost protocols",            population: 180, color: "#3a2a6e", bg: "#0c0c14", essence: "the mythic",                chant: "WE RETURN UNNAMED.",         rival: "blue-synthesis",     rivalLine: "Blue networks the living. We network the absent." },
